...
// edit the processFile() function at the end of this macro.
   ...
   requires("1.33s");
   dir = "/Volumes/Documents/training(public)/";
   setBatchMode(true);
   count = 0;
   countFiles(dir);
   n = 0;
  ...
  function processFile(path, filename) {
       ...
       saveAs("Results", "/Volumes/Documents/COMP4055 Results/Results"+filename+".csv");


       selectWindow("Summary");
       saveAs("Results", "/Volumes/Documents/COMP4055 Results/Summary-"+filename+".csv");
       //close();

       selectWindow("Result of 000-1.png");
       run("Save", "save=[/Volumes/Documents/COMP4055 Results/Result-"+filename+" of 000-1.tif]");
       close();

       selectWindow("Drawing of Result of 000-1.png");
       run("Save", "save=[/Volumes/Documents/COMP4055 Results/Drawing-"+filename+" of Result of 000-1.tif]");
       close();
